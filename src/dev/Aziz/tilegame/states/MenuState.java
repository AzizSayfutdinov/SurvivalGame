...
public class MenuState extends State {
    ...
    public void render(Graphics g) {
        ...
        //Text.drawString(g, "WELCOME TO THE SURVIVAL-GAME!", handler.getGame().getWidth() / 2, handler.getGame().getHeight() / 2 - 100 , true, Color.WHITE, Assets.font50);
        // Text.drawString(g, "PRESENTATION", handler.getGame().getWidth() / 2, handler.getGame().getHeight() / 2, true, Color.WHITE, Assets.font100);
        //Text.drawString(g, "Thank you for your attention", handler.getGame().getWidth() / 2, handler.getGame().getHeight() / 2, true, Color.WHITE, Assets.font50);
        ...
        Text.drawString(g, "Use the J key to attack!", 50, 130, false, Color.RED, Assets.font28);
        Text.drawString(g, "Use space key to shoot fireballs!", 50, 160, false, Color.RED, Assets.font28);
        Text.drawString(g, "Good luck!", 50, 190, false, Color.RED, Assets.font28);
        uiManager.render(g);
//
    }
